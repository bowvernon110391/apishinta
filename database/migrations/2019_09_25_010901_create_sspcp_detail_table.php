...
class CreateSspcpDetailTable extends Migration {
	...
	public function up()
	{
		Schema::create('sspcp_detail', function(Blueprint $table)
		{
			$table->integer('id')->unsigned()->primary();
			$table->integer('sspcp_header_id')->unsigned()->index('fk_st_detail_st_header_id_st_header_id');
